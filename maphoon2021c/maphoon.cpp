...
int main( int argc, char* argv[] ) 
{
   ...
   // There are some big variables. We create a local scope, so that they
   // will be cleaned up when they are no longer needed.
   ...
   if( argc == 4 )
   {
      ...
      {   
         ...
         if( conflicts. size( ))
         {
            std::cout << "there are unresolved conflicts:\n";
